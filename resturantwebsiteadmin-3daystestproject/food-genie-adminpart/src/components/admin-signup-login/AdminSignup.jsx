...
const FirebaseApi_key = import.meta.env.VITE_firebaseApiKey;
const FirebaseDB_URL = import.meta.env.VITE_firebaseRealtimeDb_Url;
...
const AdminSignup = () => {
  ...
  const storeUserData = async (data) => {
    try {
      ...
      await axios.post(`${FirebaseDB_URL}/admins.json`, data);
  ...
  const sendEmailVerification = async (idToken) => {
    try {
      await axios.post(
        ...
        `https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=${FirebaseApi_key}`,
        {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const signUpResponse = await axios.post(
        ...
        `https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=${FirebaseApi_key}`,
        {
