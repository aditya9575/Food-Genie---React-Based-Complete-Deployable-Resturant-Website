...
const AddRecipe = () => {
  ...
  const firebaseRecipesUrl = `${FirebaseDB_URL}/recipes.json`;
  ...
  const handleSubmit = async (e) => {
    ...
    if (editMode) {
      ...
      try {
        const recipeUrl = `${FirebaseDB_URL}/recipes/${currentRecipeId}.json`;
  ...
  const handleDelete = async (recipeId) => {
    try {
      await axios.delete(`${FirebaseDB_URL}/recipes/${recipeId}.json`);
